  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <!--      <el-form-item label="人事部主键" prop="guikey">
        <el-input v-model="queryParams.guikey" placeholder="请输入人事部id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item> -->
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['departmentHead:departmentHead:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['departmentHead:departmentHead:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['departmentHead:departmentHead:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['departmentHead:departmentHead:export']">导出</el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="departmentHeadList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <!-- <el-table-column label="主键" align="center" prop="id" /> -->
      <el-table-column label="姓名" align="center" prop="name" />
      <el-table-column label="企业微信用户id" align="center" prop="userId" />
      <el-table-column label="父id" align="center" prop="parentId" />
      <el-table-column label="角色(0 老师 1系主任 2督导)" align="center" prop="position" />
      ...
      <el-table-column label="0是导入;1是自建" align="center" prop="type" />
...
<script>
  ...
  } from "@/views/rzykapi/departmentHead/api";
  import {
    listSchoolDivision,
    getSchoolDivision,
    delSchoolDivision,
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listDepartmentHead(this.queryParams).then(response => {
          this.departmentHeadList = response.rows;
      ...
      handleUpdate(row) {
        ...
        getDepartmentHead(id).then(response => {
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            if (this.form.id != null) {
              updateDepartmentHead(this.form).then(response => {
                this.$modal.msgSuccess("修改成功");
                this.open = false;
                this.getList();
              });
            } else {
              addDepartmentHead(this.form).then(response => {
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('departmentHead/departmentHead/export', {
          ...this.queryParams
        }, `departmentHead_${new Date().getTime()}.xlsx`)
      }
    }
  };
</script>