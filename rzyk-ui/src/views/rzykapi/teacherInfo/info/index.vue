<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <!--                <el-select v-model="queryParams.position" placeholder="" clearable @keyup.enter.native="handleQuery" />-->
      <!--                <el-option>老师</el-option>-->
      <!--                <el-option>系主任</el-option>-->
      <!--                <el-option>督导</el-option>-->
      <!--                </el-select>-->
      <!--            </el-form-item>-->
...
<script>
  ...
  import {
    ...
    addInfo,
    updateInfo
  } from "@/views/rzykapi/teacherInfo/info/js/info.js";
  import {
    listSchoolDivision,
    getSchoolDivision,
    delSchoolDivision,
