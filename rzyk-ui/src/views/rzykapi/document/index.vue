<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="材料详情" prop="detail">
        <el-input v-model="queryParams.detail" placeholder="请输入材料详情" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="乐观锁" prop="revision">
        <el-input v-model="queryParams.revision" placeholder="请输入乐观锁" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="更新人" prop="updatedBy">
        <el-input v-model="queryParams.updatedBy" placeholder="请输入更新人" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="documentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="材料详情" align="center" prop="detail" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="材料详情" prop="detail">
          <el-input v-model="form.detail" placeholder="请输入材料详情" />
        </el-form-item>
        <el-form-item label="材料类型" prop="type">
          <el-input v-model="form.type" placeholder="材料类型" />
        </el-form-item>
        <!-- <el-form-item label="创建人" prop="createdBy">
...
<script>
  import {
    ...
    addDocument,
    updateDocument
  } from "@/views/rzykapi/document/document.js";
