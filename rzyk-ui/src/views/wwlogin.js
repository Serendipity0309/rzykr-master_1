! function(e, n) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = n() : "function" == typeof define &&
        define.amd ? define(n) : (e = e || self).WwLogin = n()
}(this, (function() {
    "use strict";
    ...
    return function() {
        function o() {
            ...
            e(this, o), n.version = "1.2.4", this.options = n, this.url = this.getUrl(n), this.init(this
                .url)
        }
        var i, s, r;
        return i = o, (s = [{
            ...
            value: function(e) {
                ...
                for (var o in e) e[o] && "id" !== o && n.push("".concat(o, "=").concat(e[
                    o]));
                ...
                if (!i) throw new Error(
                    "Argument business_type not match. Current version is ".concat(
                        "1.2.4", "."));
                return "".concat("https://open.work.weixin.qq.com").concat(i, "?").concat(n
                    .join("&"))
            }
        }, {
            key: "createFrame",
            value: function(e) {
                ...
                n.src = e, n.frameBorder = "0", n.allowTransparency = "true", n.scrolling =
                    "no", n.width = "300px", n.height = "400px", t.innerHTML = "", t
                    .appendChild(n), n.onload = function() {
                        n.contentWindow.postMessage && window.addEventListener && (window
                            .addEventListener("message", (function(e) {
                                var n = e.data;
                                "string" == typeof n && /^http/.test(n) && n &&
                                    e.origin.indexOf("work.weixin.qq.com") > -
                                    1 && (window.location.href = n)
